...
@Component({
  ...
  template: `
    <div class="rb-card-form card flex flex-col gap-0" [class.card-hoverable]="hoverable">
      <!-- Card Form Header -->
      ...
      <!-- Card Form Body -->
      <div class="rb-card-form-body flex flex-col gap-4 px-5" [class.py-5]="!title">
        <ng-content></ng-content>
      </div>

      <!-- Card Form Footer -->
      <div class="rb-card-form-footer flex justify-end gap-2 px-5 pt-4 pb-5 mt-4 border-t">
